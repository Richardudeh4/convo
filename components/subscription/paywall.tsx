import { Text, View, StyleSheet, Dimensions, Modal, Pressable, ScrollView, useWindowDimensions} from "react-native";
...
>
  <Defs>
    <SvgLinearGradient id="paywallBackdrop" x1="0%" y1="0%" x2="0%" y2="100%">
      <Stop offset="0%" stopColor={Colors.primaryAccentColor} />
      <Stop offset="40%" stopColor="#0f766e" />
      <Stop offset="100%" stopColor="#1a1a2e" />
    </SvgLinearGradient>
  </Defs>
  <Rect x={0} y={0} width={screenW} height={screenH} fill="url(#paywallBackdrop)" />
</Svg>
...
<Text style={styles.title}>Join Over <Text style={styles.highlight}> 50000+</Text> Users</Text>
...
<View style={styles.featuresContainer}>
{
    ...
    <Ionicons name={feat.icon as any} size={24} color={Colors.primaryAccentColor}/>
            </View>
...
<View style={styles.toggleContainer}>
    <Pressable style={[styles.toggleButton, billingCycle === "annual" && styles.toggleButtonActive]} onPress={() => setBillingCycle("annual")}>
...
<Text style={styles.savingsText}>
  {plans.annual.savings}
    ...
    <Pressable style={[styles.toggleButton, billingCycle === "monthly" && styles.toggleButtonActive]} onPress={() => setBillingCycle("monthly")}>
...
<Text style={styles.footer}>Try 7 days free. you can cancel anytime.</Text>
<Text style={styles.footerNote}>We'll notifiy you before charging your card.</Text>
<View style={styles.rating}>
<View style={styles.stars}>
 {[...Array(5)].map((_, i) => (<Ionicons key={i} name="star" size={18} color="#FFD700 " />))}
</View>
<Text style={styles.ratingText}>4.8/ 5 STARS</Text>
<Text style={styles.ratingSubtext}>Based on 1000+ on app store</Text>
</View>
<View style={styles.testimonial}>
   <Text style={styles.testimonialText}>
    Convo has the best curriculum among all the other language learning apps.
   </Text>
   <Text style={styles.testimonialAuthor}>
    -- App Store User from Nigeria
   </Text>
</View>

      ...
      <View style={styles.backdrop}>
        <Pressable style={StyleSheet.absoluteFill} onPress={onCancel}/>
          <ThemedView style={styles.card}>
            ...
            {description ? (
                <ThemedText style={styles.description} type="defaultSemiBold">
                    {description}
                </ThemedText>
            ): null}
            <View style={styles.actions}>
                ...
                <Pressable style={[styles.button, destructive ? styles.destructive : styles.confirm]} onPress={onConfirm}>
                    <ThemedText type="defaultSemiBold" style={destructive ? styles.destructiveText : styles.confirmText}>{confirmLabel}</ThemedText>
                </Pressable>
            </View>
          </ThemedView>
